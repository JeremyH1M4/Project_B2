...
document.getElementById("startBtn").addEventListener("click", function() {
    let choice = prompt("Your team has reached the edge of an enemy camp. Do you (1) sneak in quietly or (2) attack them in surprise or (3) call in an airstrike? TYPE 1, 2, or 3.");
    if (choice === "1") {
        alert("Your team sneaks through the camp undetected...");
        // ...rest of your logic
    } else if (choice === "2") {
        alert("Your team launches a surprise attack...");
        // ...rest of your logic
    } else if (choice === "3") {
        alert("You call in an airstrike...");
        // ...rest of your logic
    } else {
        alert("Invalid choice.");
    }
